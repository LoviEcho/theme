...
# Unduh file tema
wget -O /root/C2.zip https://github.com/LoviEcho/theme/raw/main/C2.zip
...
install_NookTheme() {
  ...
  # Unduh file tema dari repository
  wget -O /root/NookTheme.zip https://github.com/Nookure/NookTheme/archive/refs/heads/main.zip

  # Ekstrak file tema
  unzip /root/NookTheme.zip -d /root/

  # Salin tema ke direktori Pterodactyl
  sudo cp -rfT /root/NookTheme-main /var/www/pterodactyl
  ...
  # Hapus file dan direktori sementara
  sudo rm /root/NookTheme.zip
  sudo rm -rf /root/NookTheme-main
